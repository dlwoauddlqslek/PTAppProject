...
public class PtMemberView {
    ...
    public static PtMemberView getInstance() {
        return ptMemberView;
    }
    // /싱글톤 패턴
    ...
    public void index() {
        ...
        while (true) {
            ...
            if (ch >= 1 && ch <= 10) { // 쪽지 상세보기
                ...
                System.out.print(">>새 키 측정결과를 1cm 단위까지 입력해주세요 : ");
                ...
                if (result) {
                    ...
                    System.out.println(">>수정 실패. 다시 입력해주세요.");
                }
                ...
                MemberDto memberDto = new MemberDto();
                memberDto.setID(removeId);
                memberDto.setPW(removePw);
        ...
        public void showMessage (MessageDto msgDto){
            ...
            System.out.print("받은 시간 : ");
            System.out.println(msgDto.getMsgDate());
            System.out.print("보낸 회원 : ");
